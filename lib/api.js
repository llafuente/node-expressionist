    ...
    exports.api = function (express_server) {
        ...
        return {
            ...
            call: function (method, uri, req, callback) {
                ...
                cfg.handler(req, res, function (response, http_code, headers) {
            ...
            */
            handler: function (callback) {
                ...
                methods[current.method][current.uri].handler = (function (self) {
                    ...
                    return function (req, res, direct_call) {
                        ...
                        next = function (response) {
                            ...
                            if (res.finished === false) {
                                if (!is_object) {
                                    if (direct_call) {
                                        return direct_call({success: false, error: "invalid-output-type", ex: response}, 500, response.headers);
                                    }
                                ...
                                if (direct_call) {
                                    return direct_call(response.response, response.http_code, response.headers);
                                }
