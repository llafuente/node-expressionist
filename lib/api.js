    ...
    exports.api = function (express_server) {
        ...
        return {
            ...
            define_hook: function (hook_name, callback_before_handler, callback_before_return, doc_data) {
                ...
                if (callback_before_handler !== null && callback_before_handler.length !== 3) {
                    throw new Error("callback_before_handler must have 3 parameters");
                }
                if (callback_before_return !== null && callback_before_return.length !== 4) {
                    throw new Error("callback_before_return must have 4 parameters");
                }
            ...
            */
                ...
                methods[current.method][current.uri].handler = (function (self) {
                    ...
                    return function (req, res) {
                        ...
                        function next(response) {
                            ...
                            //console.log("#check", response === true, is_object, response.code === 200);

                            if (response === true || (is_object && response.code === 200)) {
                                switch(where) {
                                    case 'hooks-before':
                                        ...
                                        return hooks[chooks[hook_itr]].callback_before_handler(req, res, next);
                                    ...
                                    case 'hooks-response':
                                        ...
                                        return hooks[chooks[hook_itr]].callback_before_return(req, res, response, next);
                            ...
                            self.ret(res, response.response, response.code, rcheck);
                        }; // end of next
            ...
            ret: function (res, json, status, structure) {
                ...
                if (status === 200) {
                    ...
                    if (errors !== false) {
                        res.statusCode = 500;
                        return res.send(JSON.stringify({success: false, errors: errors}));
                    }
                }
