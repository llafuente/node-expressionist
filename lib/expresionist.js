(function () {
    ...
    expresionist.prototype.loadYML = function (yml_files, group, callback) {
        ...
        if ("development" === enviroment) {
            __dev_info("load YML(s) ", yml_files, group);
        }
        ...
        var data = '',
            ...
            load_next = function () {
                if (yml_files.length === yml_file_id) {
                    ...
                    if ("development" === enviroment) {
                        __dev_info("reading YML: ", yml_file);
                    }
    ...
    function uri_parameters(app, type, bag, documentation, path) {
        if (!bag) {
            return null;
        }
        path = path || "";
        ...
        for (idx in bag) {
            ...
            if ("object" === bag[idx].cast) {
                bag[idx].object = uri_parameters(app, type, bag[idx].object, documentation, path + idx + ".");
            }
    ...
    expresionist.prototype.uri = function (uri, method, options) {
        if ("development" === enviroment) {
            __dev_info("define uri", method, ":", uri);
        }
        ...
        params = uri_parameters(this.app, "params", options.params, this.documentation);
        query = uri_parameters(this.app, "query", options.get, this.documentation);
        body = uri_parameters(this.app, "body", options.post, this.documentation);
        response = uri_parameters(this.app, "response", options.response || {}, this.documentation);
    ...
    expresionist.prototype.exportDoc = function (file, groups) {
        ...
        if (file) {
            fs.writeFile(dir + path.sep + file, doc, function (err) {
                if (err) {
                    throw err;
                }
                fs.readFile(__dirname + '/documentator.css', function (err, data) {
                    ...
                    fs.writeFile(dir + path.sep + "documentator.css", data, function () {
                        if (err) {
                            throw err;
                        }
                    });
                ...
                fs.readFile(__dirname + '/documentator.html.js', function (err, data) {
                    ...
                    fs.writeFile(dir + path.sep + "documentator.html.js", data, function () {
                        if (err) {
                            throw err;
                        }
                    });
