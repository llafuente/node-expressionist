(function () {
        ...
        for (name in validation) {
            ...
            if (constraints) {
                ...
                if (current_value === undefined) {
                    ...
                    if (param_properties.default !== undefined) {
                        to_check[name] = param_properties.default;
                    }
    ...
    function handle_iteration(req, res, express_next, self) {
        ...
        case "setup":
            ...
            search.forEach(function (target) {
                ...
                if (validation !== null) {
                    ...
                    exp.validateObject(validation, to_check, {cast: true}, res);
                }
        ...
        // validate response!
        if (!res.hasErrors() && this.route.response.success === true) {
